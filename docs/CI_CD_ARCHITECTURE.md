...
│  │ • 72KB artifact  │  │ • Tests          │  │   - static       │ │
│  │                  │  │ • 19MB artifact  │  │   - alpine       │ │
...
```
build-adep-logic ─┐
                  ├──> integration-test ──> release (if v* tag)
build-engine ─────┤                              │
                  │                              │
build-client ─────┘                              │
                                                 │
...
├─ build-client (×3):  ~2-3 min each (parallel)
├─ test-client:        ~1-2 min
...
├─ build-client (×3):  ~1 min each (parallel)
├─ test-client:        ~30 sec
