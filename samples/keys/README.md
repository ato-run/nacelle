...
This generates a fresh Ed25519 keypair in StoredKey JSON format (same format as used by `ato keygen`).
...
- For production key generation, use: `ato keygen --name <name>`
