...
This generates a fresh Ed25519 keypair in StoredKey JSON format (same format as used by `capsule keygen`).
...
- For production key generation, use: `capsule keygen --name <name>`
