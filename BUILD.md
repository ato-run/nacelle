...
Capsuledは、macOS上からすべてのプラットフォーム向けのバイナリをビルドできます。
...
- `capsuled-macos-universal` - macOS Universal Binary (x86_64 + arm64)
- `capsuled-linux-x86_64` - Linux x86_64 (静的リンク、musl)
- `capsuled-linux-aarch64` - Linux ARM64 (静的リンク、musl)
- `capsuled-windows-x86_64.exe` - Windows x86_64 (MinGW)
