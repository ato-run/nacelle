...
"#;
    ...
    for _ in 0..ITERATIONS {
        let _manifest: Result<nacelle::capsule_types::capsule_v1::CapsuleManifestV1, _> =
            nacelle::capsule_types::capsule_v1::CapsuleManifestV1::from_toml(SAMPLE_TOML);
    }
    ...
    let manifest =
        nacelle::capsule_types::capsule_v1::CapsuleManifestV1::from_toml(SAMPLE_TOML).unwrap();
    let start = Instant::now();
    for _ in 0..ITERATIONS {
